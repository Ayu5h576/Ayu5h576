...
const workflowYaml = [
  ...
  '      - name: Commit changes',
  '        run: |',
  '          git config --local user.email "ayushrawat9oct@gmail.com"',
  '          git config --local user.name "Ayush Rawat"',
  '          git add README.md',
...
// 7. Minimalist, high-end, clean ASCII README.md
...
console.log('Successfully wrote 100% clean ASCII & UTF-8 files!');
